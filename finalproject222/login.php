...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!hash_equals((string) $_SESSION['csrf_token'], $submittedToken)) {
        ...
        $signupRole = strtolower(trim(isset($_POST['signup_role']) ? (string) $_POST['signup_role'] : 'customer'));
        ...
        $loginRole = strtolower(trim(isset($_POST['login_role']) ? (string) $_POST['login_role'] : 'customer'));
            ...
            <div class="auth-right">
                <div class="form-container <?php echo $activeForm === 'signup' ? 'hidden' : ''; ?>" id="loginForm">
                    ...
                    <form id="login" method="post" action="" novalidate>
                        ...
                        <div class="input-group <?php echo isset($loginErrors['role']) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-box">
                                ...
                                <select
                                    id="loginRole"
                                    name="login_role"
                                    aria-describedby="loginRoleError"
                                    <?php echo isset($loginErrors['role']) ? 'aria-invalid="true"' : ''; ?>
                                    required
                                >
                            ...
                            <small id="loginRoleError"><?php echo escape($loginErrors['role'] ?? ''); ?></small>
                        </div>
                ...
                <div class="form-container <?php echo $activeForm === 'signup' ? '' : 'hidden'; ?>" id="signupForm">
                    ...
                    <form id="signup" method="post" action="" novalidate>
                        ...
                        <div class="input-group <?php echo isset($signupErrors['role']) ? 'has-error' : ''; ?>">
                            ...
                            <div class="input-box">
                                ...
                                <select
                                    id="signupRole"
                                    name="signup_role"
                                    aria-describedby="signupRoleError"
                                    <?php echo isset($signupErrors['role']) ? 'aria-invalid="true"' : ''; ?>
                                    required
                                >
                            ...
                            <small id="signupRoleError"><?php echo escape($signupErrors['role'] ?? ''); ?></small>
                        </div>
